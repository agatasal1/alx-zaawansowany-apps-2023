...
const apartmentId = (0, _helpersDefault.default)(window.location.search);
...
(0, _apartments.getApartment)(apartmentId).then((apartment)=>{
...
const handleEditApartment = (event)=>{
    ...
    return saveApartment(editedApartment).then(()=>{
        window.location.href = "/index.html";
    });
};
detailApartmentForm.addEventListener("submit", handleEditApartment);

},{"./shared/apartments":"ayinE","./shared/helpers":"9G7TO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ayinE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
exports.default = getIdFromSearchParams;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["a3yxP","hPCZF"], "hPCZF", "parcelRequire4af5")
